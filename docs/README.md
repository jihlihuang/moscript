...
| 樣式系統 | Tailwind CSS 3 |
| 後端運行 | Node.js (Next.js Route Handlers) |
...
| F04 | 字圖上傳（含多字拆圖） | [F04-字圖上傳.md](features/F04-字圖上傳.md) |
...
| F08 | 後台管理（含字組管理） | [F08-後台管理.md](features/F08-後台管理.md) |
...
| T09 | glyph_sets | 字組表 | [T09-glyph_sets.md](schema/T09-glyph_sets.md) |
