  ...
  return (
    <>
      <button
        ...
        className="mb-3 flex items-center gap-2 rounded-xl border border-stone-200 bg-stone-50 px-3 py-2 text-xs text-stone-600 hover:border-red-700 hover:text-red-800"
      >
